(() => {
    ...
    toggle.type = 'button'; toggle.className = 'admin-menu-toggle';
    ...
    overlay.className = 'admin-menu-overlay'; overlay.hidden = true;
    ...
    function setOpen(value, focus = true) {
        ...
        main.inert = open;
        if (focus) { if (open) sidebar.querySelector('.admin-menu-close').focus(); else if (!desktop.matches) toggle.focus(); }
    }
    toggle.addEventListener('click', () => setOpen(!open));
    sidebar.querySelector('.admin-menu-close').addEventListener('click', () => setOpen(false));
